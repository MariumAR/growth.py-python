...
st.write("Transform your file between CVS and Excel formula with built-in data cleaning and visualization!")

uploaded_file = st.file_uploader("upload your files (Cvc or Excel):", type={"csv","xls"}, accept_multiple_files=True)
